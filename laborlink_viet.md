...
>
> Theo Kotler, sản phẩm bao gồm 3 lớp giá trị:
> - **Core Value (Lớp 1):** Lợi ích cốt lõi – lý do khách hàng tìm đến sản phẩm
> - **Actual Product (Lớp 2):** Sản phẩm thực tế – tên gọi, thiết kế, tính năng, chất lượng
> - **Augmented Product (Lớp 3):** Sản phẩm gia tăng – dịch vụ hậu mãi, chăm sóc khách hàng, giá trị vượt kỳ vọng

```
           ┌──────────────────────────────────────────┐
           │        SẢN PHẨM GIA TĂNG (Lớp 3)        │
           │    Học viện, Tích điểm, Bảo hiểm, CSKH   │
           │   ┌──────────────────────────────────┐   │
           │   │   SẢN PHẨM THỰC TẾ (Lớp 2)      │   │
           │   │  App, Gợi ý thông minh, Chat,     │   │
           │   │  Huy hiệu xác minh, Đánh giá     │   │
           │   │   ┌──────────────────────────┐   │   │
           │   │   │  GIÁ TRỊ CỐT LÕI (Lớp 1)│   │   │
           │   │   │ "Kết nối đúng người      │   │   │
           │   │   │  đúng việc, đúng lúc"    │   │   │
           │   │   └──────────────────────────┘   │   │
           │   └──────────────────────────────────┘   │
...
| Đối tượng | Nhu cầu cốt lõi | LaborLink giải quyết bằng cách nào |
|-----------|------------------|-------------------------------------|
...
| Khách hàng nghĩ họ mua... | Thực tế họ đang tìm kiếm... | LaborLink mang lại... |
|---------------------------|-----------------------------|-----------------------|
| "Một ứng dụng tìm việc" | **Sự an tâm** rằng sẽ tìm được việc phù hợp | Gợi ý việc đúng nhu cầu + DN đã xác minh |
| "Một nền tảng đăng tuyển" | **Tiết kiệm thời gian** và tuyển đúng người | Sàng lọc tự động, gợi ý chính xác |
...
|------------|----------|-------------------|
| **Tên sản phẩm** | **LaborLink** | "Labor" (lao động) + "Link" (kết nối) → Dễ nhớ, truyền tải đúng sứ mệnh, dùng được cả tiếng Anh & tiếng Việt |
| **Slogan** | *"Việc đúng – Người đúng – Ngay lúc này"* | 3 giá trị cốt lõi gói gọn trong 1 câu, dễ nhớ cho cả 2 phân khúc khách hàng |
| **Hình thức sản phẩm** | Ứng dụng di động (iOS + Android) + Trang web | Gen Z ưu tiên tìm việc qua điện thoại; DN nhỏ có thể dùng trên máy tính |
| **Phong cách thiết kế** | Hiện đại, tối giản, dễ dùng | Giảm rào cản sử dụng cho cả SV (thích nhanh gọn) và chủ DN nhỏ (không quen ứng dụng phức tạp) |


---

### Hệ thống tính năng (Phân tích theo Giá trị mang lại cho khách hàng)


#### Nhóm 1: TÍNH NĂNG GỢI Ý THÔNG MINH (Giải quyết bài toán "tìm đúng người – đúng việc")

| # | Tính năng | Bài toán kinh doanh cần giải quyết | Giá trị mang lại | Kết quả kỳ vọng |
|---|----------|-------------------------------------|-------------------|-----------------|
| 1 | **Gợi ý ứng viên/việc làm thông minh** | DN đăng Facebook nhận 50+ tin nhắn nhưng chỉ 5–10% phù hợp; SV phải lướt hàng trăm bài mới tìm được 1 việc ưng | Hệ thống tự động phân tích hồ sơ ứng viên & yêu cầu tuyển dụng → Đề xuất danh sách phù hợp nhất, xếp hạng theo điểm tương thích (0–100%) | Giảm **70% thời gian sàng lọc** cho DN; Giảm **80% thời gian tìm kiếm** cho SV |
| 2 | **Đồng bộ lịch học – lịch làm việc** | 73% SV từng phải từ chối việc vì ca làm trùng lịch thi → 30–40% nhân viên part-time nghỉ sau 1–2 tuần vì lịch không hợp | SV nhập lịch học → Hệ thống chỉ hiển thị việc có ca trùng giờ rảnh; DN nhập ca làm → Chỉ thấy SV phù hợp khung giờ | Giảm **50% tỷ lệ nghỉ việc sớm** do xung đột lịch; **100%** việc được gợi ý đều phù hợp lịch |
| 3 | **Hỗ trợ viết mô tả công việc** | 58% chủ DN nhỏ cho biết "lười" viết mô tả tuyển dụng vì mất thời gian và không biết viết sao cho hấp dẫn | DN chỉ cần nhập vài từ khóa (vd: "phục vụ, quán cafe, Quận 1") → Hệ thống tự tạo bài đăng tuyển dụng chuẩn, đầy đủ | Giảm thời gian đăng tin từ **15 phút → 3 phút** |

##### Khác biệt so với cách tìm việc hiện tại:

| Tiêu chí | Cách truyền thống (Facebook, Zalo) | LaborLink |
|----------|-----------------------------------|-----------|
| Cách tìm | SV tự lướt hàng trăm bài đăng, tự đánh giá phù hợp không | Hệ thống tự động gợi ý Top 5–10 việc phù hợp nhất |
| Xử lý lịch | Không xử lý → SV tự so lịch, hay bị trùng | Tự động lọc theo lịch rảnh → 100% phù hợp |
| Chất lượng kết nối | Ngẫu nhiên, tỷ lệ phù hợp ~30–40% | Gợi ý thông minh, tỷ lệ phù hợp mục tiêu **75–85%** |
| Thời gian tìm việc | 3–10 ngày | Vài giờ |

---

#### Nhóm 2: TÍNH NĂNG KẾT NỐI (Giải quyết bài toán "giao tiếp nhanh – thuận tiện")

| # | Tính năng | Bài toán | Giá trị | 
|---|----------|----------|---------|
| 4 | **Nhắn tin trực tiếp trong ứng dụng** | SV và DN hiện phải trao đổi qua Facebook/Zalo cá nhân → Mất thông tin, không có bằng chứng nếu xảy ra tranh chấp | Chat trong app, mọi lịch sử được lưu trữ → Bảo vệ quyền lợi cả 2 phía |
| 5 | **Đăng tin nhanh & Ứng tuyển 1 chạm** | Chủ quán ăn rất bận, không có thời gian làm quy trình dài; SV muốn nhanh gọn | DN đăng tin trong **3 phút**; SV ứng tuyển **1 chạm** với hồ sơ có sẵn |
| 6 | **Thông báo việc mới thông minh** | Các app thường spam thông báo → SV tắt notification → Bỏ lỡ cơ hội | Chỉ thông báo khi có việc phù hợp **>70% điểm tương thích** → Không spam, tỷ lệ đọc cao |

---

#### Nhóm 3: TÍNH NĂNG TIN CẬY & AN TOÀN (Giải quyết bài toán "niềm tin – giảm rủi ro")

> **Tại sao nhóm này quan trọng?** Khảo sát cho thấy 91% SV coi "an toàn" là yếu tố quan trọng nhất. Đây là rào cản lớn nhất khiến SV ngại tìm việc qua kênh online và là **điểm khác biệt lớn nhất** của LaborLink so với Facebook Groups.
...
#### Nhóm 4: TÍNH NĂNG PHÁT TRIỂN (Tăng giá trị sử dụng lâu dài)
...
| Cam kết | Nội dung |
|---------|----------|
| **Xác minh danh tính** | DN: Giấy phép kinh doanh + CMND; SV: Email trường (*.edu.vn) + CMND |
| **Bảo mật thông tin** | Tin nhắn được mã hóa, chỉ 2 người trong cuộc đọc được |
| **Tuân thủ pháp luật** | Tuân thủ Nghị định 13/2023 về bảo vệ dữ liệu cá nhân tại Việt Nam |
...
>
> **Ví dụ:** Shopee và Lazada có tính năng mua bán giống nhau (Lớp 2), nhưng Shopee thắng nhờ ShopeePay, Shopee Live, chương trình tích xu, mini game... – tất cả là **sản phẩm gia tăng** (Lớp 3).
...
| Chiến lược | Định nghĩa ngắn gọn | Ví dụ quen thuộc |
|-----------|---------------------|-------------------|
...
|---|-------|---------------------|
| 1 | **Thị trường 2 phía** (Two-sided marketplace) | LaborLink cần đồng thời thu hút cả SV và DN. Giống Grab cần cả tài xế lẫn khách – nếu không có SV thì DN không đăng ký, nếu không có DN thì SV không dùng. → Cần **miễn phí** để khởi động vòng xoay |
| 2 | **Khách hàng DN nhạy cảm giá** | Hộ KD nhỏ (quán ăn, cafe) ngân sách tuyển dụng **gần = 0** → Phải miễn phí hoặc rất rẻ để họ chịu dùng thử |
| 3 | **Thị trường mới, chưa có thói quen** | Chưa ai quen trả tiền cho nền tảng tuyển dụng part-time → Cần cho dùng miễn phí trước để **thay đổi hành vi**, giống cách Grab cho free ride khi mới ra mắt |
| 4 | **Để sản phẩm tự chứng minh giá trị** | DN dùng gói Free → Thấy tuyển nhanh hơn, đúng hơn → **Tự nguyện** nâng cấp lên gói trả phí. Chiến lược "Land and Expand" – vào cửa trước, mở rộng sau |
| 5 | **Tạo hiệu ứng mạng lưới (Network Effect)** | Càng nhiều user → Nền tảng càng có giá trị → Càng khó cho đối thủ mới. Giống Facebook: khi tất cả bạn bè bạn đã ở đó, bạn không chuyển sang mạng xã hội khác |
...
| Tính năng | Quyền sử dụng |
|----------|:-------------:|
| Tạo hồ sơ, nhận gợi ý việc phù hợp | ✅ Miễn phí |
| Ứng tuyển không giới hạn | ✅ Miễn phí |
| Đồng bộ lịch học | ✅ Miễn phí |
| Chat với nhà tuyển dụng | ✅ Miễn phí |
...
| Góc nhìn | Phân tích |
|----------|----------|
| **Đủ để trải nghiệm** | Quán cafe nhỏ cần 1–2 nhân viên/tháng → 2 tin FREE đủ dùng thử |
| **Tạo "bức tường tự nhiên"** | Khi DN thấy hiệu quả và cần tuyển nhiều hơn → Tự nguyện trả phí. Giống Spotify: nghe miễn phí nhưng muốn bỏ quảng cáo thì trả phí |
| **Tỷ lệ chuyển đổi ngành** | Benchmark SaaS toàn cầu: 2–5% user Free chuyển sang trả phí. LaborLink mục tiêu **35%** (cao hơn vì giá cực thấp + giá trị rõ ràng) |

#### Tại sao gói Cơ bản là 99.000đ?

| Góc nhìn | Phân tích |
|----------|----------|
| **Tâm lý giá (Price Psychology)** | 99K < 100K → Người mua cảm nhận "dưới 100 ngàn" → Ra quyết định nhanh, không cần suy nghĩ |
| **So sánh tương đối** | 99K ≈ giá 1 ly trà sữa size L → Chi phí không đáng kể so với giá trị nhận được (10 tin + gợi ý thông minh + xác minh) |
| **Khả năng chi trả** | Quán ăn nhỏ doanh thu 30–50 triệu/tháng → 99K = **0,2–0,3% doanh thu** → Hoàn toàn chấp nhận được |
| **So với đối thủ** | JobsGO thấp nhất 500K/tin → LaborLink 99K/THÁNG (10 tin) = **thấp hơn ~80%** |

#### Tại sao gói Nâng cao là 299.000đ?
